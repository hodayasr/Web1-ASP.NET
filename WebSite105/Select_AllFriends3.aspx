...
<script runat="server">
    ...
    public void Page_load()
    {
        ...
        string stsql = "select *from TBtofes3";
        ...
        htmlstr.Append("<TD>"); htmlstr.Append("birthyear"); htmlstr.Append("</TD>");
        ...
        htmlstr.Append("<TD>"); htmlstr.Append("min"); htmlstr.Append("</TD>");
        htmlstr.Append("<TD>"); htmlstr.Append("email"); htmlstr.Append("</TD>");
        htmlstr.Append("<TD>"); htmlstr.Append("password"); htmlstr.Append("</TD>");
        htmlstr.Append("<TD>"); htmlstr.Append("Question"); htmlstr.Append("</TD>");
        ...
        for (int i = 0; i < dt.Rows.Count; i++)
        {
            ...
            htmlstr.Append("<TD>");
            htmlstr.Append(dt.Rows[i]["birthyear"]); htmlstr.Append("</TD>");
            htmlstr.Append("<TD>");
            ...
            htmlstr.Append("<TD>");
            htmlstr.Append(dt.Rows[i]["min"]); htmlstr.Append("</TD>");
            htmlstr.Append("<TD>");
          
            htmlstr.Append(dt.Rows[i]["email"]); htmlstr.Append("</TD>");
            htmlstr.Append("<TD>");
            htmlstr.Append(dt.Rows[i]["password"]); htmlstr.Append("</TD>");
            htmlstr.Append("<TD>");
            htmlstr.Append(dt.Rows[i]["Question"]); htmlstr.Append("</TD>");
            htmlstr.Append("<TD>");
...
<html ><head>    <title>רשימת חברים מצורפים</title>
    <style type="text/css">
        .style54
        {
            text-align: right;
